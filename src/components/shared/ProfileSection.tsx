...
// const check='xion1rs2tnhe4mxpjnedhc84pc0v7mcy5gtmglx8896'
  ...
  return (
    <Card className="w-full md:w-1/3 p-6 shadow-lg rounded-2xl bg-white dark:bg-gray-900">
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="text-xl font-semibold mt-4 text-gray-800 dark:text-white">John Doe</h2>
        ...
        <div className="mt-6 flex gap-4">
          <Button variant="outline" className="w-36">View Profile</Button>
